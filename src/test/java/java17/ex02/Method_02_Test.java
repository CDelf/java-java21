...
public class Method_02_Test {
    ...
    interface IDao {
        ...
        default String format() {
            StringBuilder result = new StringBuilder().append(findAll().size()).append(" persons");
    ...
    class DaoA implements IDao {
        ...
        public String format() {
           StringBuilder result = new StringBuilder().append(getClass().getSimpleName()).append("[").append(IDao.super.format()).append("]");
           return result.toString();
        }
    }
    // end::DaoA[]
