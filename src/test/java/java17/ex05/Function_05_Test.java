...
public class Function_05_Test {
    ...
    Consumer<Person> verifyAge = (p) -> assertTrue("Age should be > 4", p.getAge() > 4);

    // TODO compléter la fonction
    // TODO vérifier que le mot de passe est "secret" avec une assertion JUnit
    Consumer<Person> verifyPassword = (p) -> assertTrue("incorrect password", p.getPassword().equals("secret"));
    //end::functions[]
